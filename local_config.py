...
LOGGING_LEVEL = "INFO"
CITATION_HELPER_API_TOKEN = ''
CITATION_HELPER_CHUNK_SIZE = 1
CITATION_HELPER_MAX_HITS = 1
CITATION_HELPER_MAX_INPUT = 1
CITATION_HELPER_MAX_SUBMITTED = 1
CITATION_HELPER_NUMBER_SUGGESTIONS = 1
