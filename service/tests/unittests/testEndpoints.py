...
class TestGoodRequests(TestCase):
  ...
  def test_service_results(self):
    ...
    expected = [{u'title': u'p_title', u'bibcode': u'p', u'score': 3, u'author': u'p_author,+'}, 
                {u'title': u'x_title', u'bibcode': u'x', u'score': 2, u'author': u'x_author,+'}, 
                {u'title': u'y_title', u'bibcode': u'y', u'score': 2, u'author': u'y_author,+'}]
