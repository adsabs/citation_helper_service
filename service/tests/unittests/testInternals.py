...
class TestConfig(TestCase):
  ...
  def test_config_values(self):
    ...
    required = ["CITATION_HELPER_MAX_HITS","CITATION_HELPER_MAX_INPUT","CITATION_HELPER_MAX_SUBMITTED","CITATION_HELPER_CHUNK_SIZE","CITATION_HELPER_NUMBER_SUGGESTIONS","CITATION_HELPER_THRESHOLD_FREQUENCY","CITATION_HELPER_SOLRQUERY_URL","DISCOVERER_PUBLISH_ENDPOINT","DISCOVERER_SELF_PUBLISH"]
